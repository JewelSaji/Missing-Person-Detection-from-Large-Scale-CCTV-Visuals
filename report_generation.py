...
# performance_stats = {
#     "total_processing_time": 325.6,
#     "frames_processed": 12500,
#     "frames_per_second": 38.4,
#     "processing_times": {
#         "video1.mp4": 45.2,
#         "video2.mp4": 62.8,
#         "video3.mp4": 38.1
...
# def add_confidence_visualization(pdf, detections, detection_type):
#     """Add confidence visualization to PDF report"""
#     if not detections:
#         return
        
#     confidences = [d['similarity'] if detection_type == 'face' else d['probability'] for d in detections]
    
#     plt.figure(figsize=(8, 3))
#     plt.hist(confidences, bins=20, alpha=0.7, color='blue' if detection_type == 'face' else 'red')
#     plt.title(f'{detection_type.capitalize()} Confidence Distribution')
#     plt.xlabel('Confidence Score')
#     plt.ylabel('Count')
#     plt.grid(True, alpha=0.3)
    
#     # Save to temp file
#     temp_path = os.path.join(tempfile.gettempdir(), f'{detection_type}_confidence.png')
